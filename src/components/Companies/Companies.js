    ...
    return(
        <div className={classes.Container} id="proplacements">
            ...
            <div className={classes.Companies}>
                <p>"... and such skills are in demand all over the industry."</p>
                <p className={classes.subquote}>The best coding bootcamps simulate a real-world software environment for their students; the grads are so well-prepared, they come in and hit the ground running, that’s really what we’re looking for.</p>
                <div className={classes.Line}></div>
